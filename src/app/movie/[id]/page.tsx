        ...
        <div className="absolute bottom-[10%] md:bottom-[15%] left-4 md:left-12 lg:left-24 max-w-4xl z-20 pointer-events-none">
            <div className="space-y-4 md:space-y-6 animate-in fade-in slide-in-from-bottom-10 duration-700">
                <div className="flex flex-wrap items-center gap-2 md:gap-3">
                    ...
                    <Badge variant="outline" className="border-white/20 text-white font-bold backdrop-blur-md uppercase tracking-widest text-[8px] md:text-[10px]">4K HDR</Badge>
                </div>
          ...
          <div className="w-full lg:w-[400px] flex-shrink-0 space-y-6 md:space-y-10">
            ...
            <div className="grid grid-cols-1 gap-3 md:gap-5">
                ...
                <div className="flex gap-3 md:gap-4">
                    <Button onClick={handleSaveToggle} variant={isSaved ? "secondary" : "outline"} className="flex-1 rounded-xl md:rounded-2xl h-14 md:h-18 border-white/10 glass-card text-sm md:text-lg font-bold transition-all hover:scale-105 active:scale-95" disabled={isSavedMovieLoading}>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 md:gap-16 pt-6 md:pt-12">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                                    {directors.slice(0, 2).map(director => (
                                        <Link href={`/person/${director.id}`} key={director.credit_id} className="flex items-center gap-3 md:gap-4 p-3 md:p-4 glass-panel rounded-xl md:rounded-2xl hover:bg-white/10 transition-all border border-white/5 group">
                                            <Avatar className="size-10 md:size-14 border-2 border-primary/50 group-hover:border-primary transition-all">
                                            ...
                                            <div>
                                                <p className="text-sm md:text-base font-black text-white group-hover:text-primary transition-colors leading-none">{director.name}</p>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                                {movie.credits.cast.slice(0, 6).map(person => (
                                    <Link href={`/person/${person.id}`} key={person.credit_id} className="flex items-center gap-3 md:gap-4 p-3 md:p-4 glass-panel rounded-xl md:rounded-2xl hover:bg-white/10 transition-all border border-white/5 group">
                                        <Avatar className="size-10 md:size-14 border-2 border-white/10 group-hover:border-primary transition-all">
                ...
                <section className="space-y-6 md:space-y-10">
                    <div className="flex items-center justify-between border-b border-white/10 pb-4">
                        ...
                        <Badge className="bg-secondary text-white font-black text-[8px] md:text-[10px] px-2 md:px-3 py-1 rounded-sm uppercase tracking-widest border border-white/10">Community</Badge>
                    </div>
