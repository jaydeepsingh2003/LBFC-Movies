    ...
    if (isLoading) {
        return (
             <div className="py-12 space-y-8 border-t border-white/5">
                <Skeleton className="h-10 w-64 rounded-full bg-yellow-400/10" />
    ...
    return (
        <section className="py-16 space-y-12 border-t border-white/5">
            <div className="flex items-center gap-4">
                <div className="p-3 bg-yellow-400/10 rounded-2xl border border-yellow-400/20 shadow-2xl shadow-yellow-400/10">
                    <Languages className="text-yellow-400 size-7 md:size-8" />
                </div>
                <div className="space-y-1">
                    <h2 className="font-headline text-3xl md:text-5xl font-black tracking-tighter uppercase text-white mb-0 leading-none">
                        Linguistic <span className="text-yellow-400">Hub: Kannada</span>
                    </h2>
                    <p className="text-[10px] md:text-xs font-black text-muted-foreground uppercase tracking-[0.4em] opacity-60">Iconic Sandalwood productions making waves globally.</p>
                </div>
            </div>
